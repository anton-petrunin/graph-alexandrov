...
Note that the graph $\Gamma$ in the corollary is described by a 5-array of integers $(m_1,k_1,\ell,k_2,m_2)$ such that $m_i\geqslant k_i$, $\ell \geqslant 0$, and $k_i>0$ if $n_i>0$.
Examples of graphs with their 5-arrays are given on the diagram.
\begin{figure}[ht!]
\centering
...
\end{figure}
For example, on the diagram you see multipath $(3,1,2,1,2,2,1,1,1,2)$. 
